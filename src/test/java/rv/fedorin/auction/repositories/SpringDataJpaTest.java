...
abstract class SpringDataJpaTest {
    ...
    private static List<User> generateUser() {
        ...
        julius.setHomeAddress(new Address("Some street", city));
        ...
        darren.setHomeAddress(new Address("Some street", city));
        ...
        marion.setHomeAddress(new Address("Some street", city));
        ...
        stephanie.setHomeAddress(new Address("Some street", city));

        User burk = new User("burk", LocalDate.of(2020, Month.NOVEMBER, 28));
        burk.setEmail("burk@somedomain.com");
        burk.setLevel(1);
        burk.setActive(true);
        burk.setHomeAddress(new Address("Some street", city));
